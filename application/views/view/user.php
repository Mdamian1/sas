        ...
        <div class="users-fundo container">
            <ul class="list-group">
                ...
                <li class="list-group-item list-btns">
                    <a class="btn btn-dark btn-user" href="<?php echo base_url('admin/deletarUser/'.$user[0]['id_pessoa']) ?>">Excluir</a>
                    <a class="btn btn-dark btn-user" href="<?php echo base_url('admin/alterarUser/'.$user[0]['id_pessoa']) ?>">Alterar</a>
                </li>
            </ul>
        </div>
    </div>
